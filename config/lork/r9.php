<?php
    ...
    class r9 extends room
    {
        ...
        public function getCommand($command) {
            $rtn = "";
            if(isset($_SESSION['roomitem']['r9']['TOUCHSCREEN']['INUSE']) && $_SESSION['roomitem']['r9']['TOUCHSCREEN']['INUSE'] == true) {
                if($command == "QUIT") {                    
                    $_SESSION['roomitem']['r9']['TOUCHSCREEN']['INUSE'] = false;
                    $rtn = array(
                        "DISPLAY"=>TOUCHQUIT
                    );
                }
                else {
                    $rtn = touchscreen::typepassword('r9', $command);
                    if(isset($_SESSION['roomitem']['r9']['TOUCHSCREEN']['STATUS']) && $_SESSION['roomitem']['r9']['TOUCHSCREEN']['STATUS'] == ACCESSGRANTED) {
                        $this->addPoints(25);
                    }
                }
            }
        ...
        function usetouchscreen() {
            return touchscreen::usetouchscreen('r9');
        }
