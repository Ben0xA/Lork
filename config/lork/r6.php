<?php
    ...
    class r6 extends room
    {
        ...
        public function getCommand($command) {
            $rtn = "";
            if(isset($_SESSION['roomitem']['r6']['TOUCHSCREEN']['INUSE']) && $_SESSION['roomitem']['r6']['TOUCHSCREEN']['INUSE'] == true) {
                if($command == "QUIT") {                    
                    $_SESSION['roomitem']['r6']['TOUCHSCREEN']['INUSE'] = false;
                    $rtn = array(
                        "DISPLAY"=>TOUCHQUIT
                    );
                }
                else {
                    $rtn = touchscreen::typepassword('r6', $command);
                    if(isset($_SESSION['roomitem']['r6']['TOUCHSCREEN']['STATUS']) && $_SESSION['roomitem']['r6']['TOUCHSCREEN']['STATUS'] == ACCESSGRANTED) {
                        $this->addPoints(25);
                    }
                }
            }
        ...
        function usetouchscreen() {
            return touchscreen::usetouchscreen('r6');
        }
